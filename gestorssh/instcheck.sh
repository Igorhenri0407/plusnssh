...
sleep 5
cd /bin || exit
wget https://github.com/Igorhenri0407/plusnssh/master/gestorssh/chuser > /dev/null 2>&1
wget https://github.com/Igorhenri0407/plusnssh/master/gestorssh/userscheck > /dev/null 2>&1
...
wget https://github.com/Igorhenri0407/plusnssh/master/gestorssh/checkuser.py > /dev/null 2>&1
