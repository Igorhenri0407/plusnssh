...
sleep 5
cd /bin || exit
wget https://github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/chuser > /dev/null 2>&1
wget https://github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/userscheck > /dev/null 2>&1
chmod 777 chuser > /dev/null 2>&1
chmod 777 userscheck > /dev/null 2>&1
clear
mkdir /etc/rec > /dev/null 2>&1
echo -e 'By: @Igorhenri0407' > /etc/rec/licence
echo -e 'By: @Igorhenri0407' > /usr/lib/licence
mkdir /usr/lib/checkuser > /dev/null 2>&1
cd /usr/lib/checkuser || exit
rm checkuser.py > /dev/null 2>&1
wget https://github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/checkuser.py > /dev/null 2>&1
