...
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-10s\n' "INSTALAR PAINELWEB GESTOR-SSH-AGOSTINHO CENTOS 7" ; tput sgr0 ; echo ""
echo "Continuar? S\n"
echo -n "> "
read option
if [ $option = "S" ]; then
...
wget https://github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/cent7/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf > /dev/null 2>&1
...
wget https://github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/gestorssh.zip > /dev/null 2>&1
...
createdb(){
wget https://github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/bdgestorssh.sql > /dev/null 2>&1
...
cd /bin || exit
wget https://github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/userteste.sh
wget https://github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/autobackup.sh
