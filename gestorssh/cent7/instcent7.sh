...
wget https://github.com/Igorhenri0407/plusnssh/master/gestorssh/cent7/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf > /dev/null 2>&1
...
wget https://github.com/Igorhenri0407/plusnssh/master/gestorssh/gestorssh.zip > /dev/null 2>&1
...
createdb(){
wget https://github.com/Igorhenri0407/plusnssh/master/gestorssh/bdgestorssh.sql > /dev/null 2>&1
...
cd /bin || exit
wget https://github.com/Igorhenri0407/plusnssh/master/gestorssh/userteste.sh
wget https://github.com/Igorhenri0407/plusnssh/master/gestorssh/autobackup.sh
