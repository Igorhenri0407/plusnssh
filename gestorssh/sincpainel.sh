#!/bin/bash
clear
echo -e "\033[1;36mINSTALANDO O SINCRONIZADOR GESTOR-SSH-AGOSTINHO\033[0m"
...
wget github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/sshplus.zip.001 > /dev/null 2>&1
wget github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/sshplus.zip.002 > /dev/null 2>&1
wget github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget github.com/Igorhenri0407/plusnssh/raw/ntech/gestorssh/sincpainel.zip > /dev/null 2>&1
