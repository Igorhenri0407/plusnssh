...
wget https://github.com/Igorhenri0407/plusnssh/ntech/gestorssh/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf
...
installweb(){
cd /var/www/html
wget https://github.com/Igorhenri0407/plusnssh/ntech/gestorssh/gestorssh.zip
unzip gestorssh.zip
...
createdb(){
wget https://github.com/Igorhenri0407/plusnssh/ntech/gestorssh/bdgestorssh.sql
...
cd $HOME || exit
wget -qO- https://github.com/Igorhenri0407/plusnssh/ntech/gestorssh/uteste > /bin/usersteste.sh
wget -qO- https://github.com/Igorhenri0407/plusnssh/ntech/gestorssh/backupauto > /bin/autobackup.sh
